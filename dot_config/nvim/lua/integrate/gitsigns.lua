return {
	...
	opts = {
		...
		on_attach = function(bufnr)
			...
			-- Toggles
			map("n", "<leader>hB", gitsigns.toggle_current_line_blame, { desc = "git toggle show [B]lame line" })
			map("n", "<leader>hL", gitsigns.toggle_deleted, { desc = "git toggle show de[L]eted" })
		end,
	},
}
