return {
	"github/copilot.vim",
	config = function()
		-- WSL workaround: https://github.com/orgs/community/discussions/50263
		...
		vim.keymap.set("i", "<C-u>", 'copilot#Accept("\\<CR>")', { expr = true, replace_keycodes = false })
		vim.keymap.set("i", "<C-o>", "<Plug>(copilot-accept-word)", { silent = true })
